  ...
  namespace storage {
    ...
    protected:
      ...
      */
      ...
      void createCellGrid(const Int3D& nodeGrid, const Int3D& cellGrid, const boost::python::list& neiListx, const boost::python::list& neiListy, const boost::python::list& neiListz);
      ...
      */
      ...
      //NeiList data Structure
      //struct NeiList {                              // H - check -
      //   std::vector< std::vector<int> > neiList;    // H - check -
      // };                                            // H - check -

      //NeiList neiList[3][3];                              // H - check - Here should come the nodeSize
