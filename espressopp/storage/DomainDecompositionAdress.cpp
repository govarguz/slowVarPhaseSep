...
namespace espressopp { 
  ...
  DomainDecompositionAdress(shared_ptr< System > _system,
    ...
    : Storage(_system), exchangeBufferSize(0) {
      // std::vector<int> neiListxV;
      // std::vector<int> neiListyV;
      // std::vector<int> neiListzV;
      // for (int i = 0; i < boost::python::len(neiListx); ++i) {
      //     neiListxV.push_back(boost::python::extract<int>(neiListx[i]));
      //     neiListyV.push_back(boost::python::extract<int>(neiListy[i]));
      //     neiListzV.push_back(boost::python::extract<int>(neiListz[i]));
      // }
  ...
  createCellGrid(const Int3D& _nodeGrid,const Int3D& _cellGrid, const boost::python::list& neiListx, const boost::python::list& neiListy, const boost::python::list& neiListz) {
    real myLeft[3];
    real myRight[3];
  ...
  void DomainDecompositionAdress::cellAdjust(){
      ...
      // creating new grids
      // createCellGrid(_nodeGrid, _newCellGrid, neiListxV, neiListyV, neiListzV);
      initCellInteractions();
      prepareGhostCommunication();
  ...
  class PyDomainDecompositionAdress : public DomainDecompositionAdress {
      public:
        PyDomainDecompositionAdress(shared_ptr< System > _system,
                  ...
                  const boost::python::list& neiListy,
                  const boost::python::list& neiListz)
      : DomainDecompositionAdress(_system, _nodeGrid, _cellGrid, neiListx, neiListy, neiListz)
        {}
      };
