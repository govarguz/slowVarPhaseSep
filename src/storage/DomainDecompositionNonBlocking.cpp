...
namespace espressopp { 
  ...
  DomainDecompositionNonBlocking(shared_ptr< System > _system,
    ...
    : DomainDecomposition(_system, _nodeGrid, _cellGrid, neiListx, neiListy, neiListz),
  ...
  void DomainDecompositionNonBlocking::registerPython() {
    ...
    ("storage_DomainDecompositionNonBlocking", init< shared_ptr< System >, const Int3D&, const Int3D&, boost::python::list&, boost::python::list&, boost::python::list& >())
    ;
  }
