...
for j in range(nsteps): 		#run nsteps x samp time
    ...
    if mdSteps>3.9999e6: #Tunned Param for J Smrek
        ...
        if dd:
            pidf, typea, xposf, yposf, zposf, xvelf, yvelf, zvelf, box_x, box_y, box_z=myGatherConfOTF(system,velocities=True,unfolded=True,mpc=1)
            runMagic(pidf, typea, xposf, yposf, zposf, xvelf, yvelf, zvelf, box_x, box_y, box_z,bending=1,num_chains,nodeGrid,rc,skin,cellGrid)
