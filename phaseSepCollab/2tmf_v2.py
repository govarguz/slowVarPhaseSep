...
if bending:
	kname = 'k1p5'
	ktheta = 1.5
        inconfpath = '/ptmp/gvargas/work/collabJSmrek/data/configurations/k1p5/N'+str(monomers_per_chain)+'/'
        inconffile = inconfpath+'prc_nc'+str(num_chains)+'N'+str(monomers_per_chain)+kname+'dT'+str(temperature2)+'t'+str(tin)+'.dat'
	outconfpath = '/ptmp/gvargas/work/collabJSmrek/data/configurations/k1p5/N'+str(monomers_per_chain)+'/'
...
nsteps = 200*int(thermostat.gamma1) #just a large number
tausteps = int(1.0/dt)
