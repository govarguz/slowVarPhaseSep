...
system.skin    = skin
nodeGrid=espressopp.Int3D(4,2,2)
cellGrid=espressopp.Int3D(7,23,23)
neiListx=[0,6,12,18,23]
neiListy=[0,11,23] # worked also with [0,23,23] for 2 cores
neiListz=[0,11,23] # worked also with [0,23,23] for 2 cores
