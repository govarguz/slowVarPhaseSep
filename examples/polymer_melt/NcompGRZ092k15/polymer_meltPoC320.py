...
system.skin    = skin
nodeGrid=espresso.Int3D(8,8,5)
cellGrid=espresso.Int3D(11,11,9)
neiListx=[0,11,22,33,44,55,66,77,88]
neiListy=[0,11,22,33,44,55,66,77,88] # worked also with [0,23,23] for 2 cores
neiListz=[0,9,18,27,36,45] # worked also with [0,23,23] for 2 cores
