...
bonds, angles, x, y, z, Lx, Ly, Lz = espressopp.tools.replicate(bonds, angles, x, y, z, Lx, Ly, Lz, xdim=4, ydim=4, zdim=2)
num_particles = len(x)
...
system.skin    = skin
nodeGrid=espressopp.Int3D(5,4,4)
cellGrid=espressopp.Int3D(18,23,11)
neiListx=[0,18,36,54,72,90]
neiListy=[0,23,46,69,92] # worked also with [0,23,23] for 2 cores
